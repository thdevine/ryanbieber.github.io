...
- [TimeSeriesCatchAll](https://github.com/ryanbieber/Time-Series-Catch-All) A time-series package that runs 1000s of models against your series in parallel. It uses Hyndman's [Forecast](https://pkg.robjhyndman.com/forecast/), [Forecasthybrid](https://cran.r-project.org/web/packages/forecastHybrid/forecastHybrid.pdf), [Prophet](https://cran.r-project.org/web/packages/prophet/prophet.pdf), and [DLM](https://cran.r-project.org/web/packages/dlm/dlm.pdf) to forecast a time-series. Currently needs to be tuned by error metric and picking a single series.
