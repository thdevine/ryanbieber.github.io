...
- [TimeSeriesCatchAll](https://github.com/ryanbieber/Time-Series-Catch-All) A time-series package that runs 1000s of models against your series in parallel. It uses Hyndman's [Forecast](https://pkg.robjhyndman.com/forecast/), [Forecasthybrid](https://cran.r-project.org/web/packages/forecastHybrid/forecastHybrid.pdf), [Prophet](https://cran.r-project.org/web/packages/prophet/prophet.pdf), and [DLM](https://cran.r-project.org/web/packages/dlm/dlm.pdf) to forecast a time-series. Is in a state where I am happy with it, it is able to go through thousands of models in parallel for a time series and based off the steps forward you want to look it is able to do the backtesting and pick the best model forward.
...
- [Social Distancing Example](https://bigthick.shinyapps.io/Social_distancing/) This shiny app was based on the SIR model to look at how social distancing works in a simple example and also how epidemics work in this classical example.